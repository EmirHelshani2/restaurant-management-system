...
function ProtectedRoute({ component: Component, roles, ...rest }: any) {
  ...
  if (roles && !roles.includes(user.role) && !roles.includes("admin")) return <Redirect to="/" />;
...
function AppContent() {
  ...
  return (
    <Switch>
      ...
      <Route path="/">
        {user ? (
          user.role === "kitchen" ? <Redirect to="/kitchen" /> :
          user.role === "bar" ? <Redirect to="/bar" /> :
          user.role === "waiter" ? <Redirect to="/waiter" /> :
          user.role === "cashier" ? <Redirect to="/cashier" /> :
          user.role === "receptionist" ? <Redirect to="/reservations" /> :
