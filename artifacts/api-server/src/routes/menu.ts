...
router.post("/menu/categories", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
...
router.patch("/menu/categories/:id", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
...
router.delete("/menu/categories/:id", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
...
router.post("/menu/items", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
...
router.patch("/menu/items/:id", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
...
router.delete("/menu/items/:id", requireAuth, requireRole("admin", "manager"), async (req, res): Promise<void> => {
  const id = parseInt(Array.isArray(req.params.id) ? req.params.id[0] : req.params.id, 10);
